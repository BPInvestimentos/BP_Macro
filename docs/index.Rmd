...
# segunda-feira
dt_inicio_semana = as.Date("2021-12-06")

# sexta-feira
dt_fim_semana = as.Date("2021-12-10")
dt_commoditie_final_semana = "10/12/2021"
...
#   cdi[3000,1] <- as.Date("2021-12-10")
#   cdi[3000,2] <- as.numeric(9.15)
# 
# ####################################################################
...
curva_seg <- read.csv2("curva-pre_2021-12-03.csv")

curva_sex <- read.csv2("curva-pre_2021-12-10.csv")
