...
# segunda-feira
dt_inicio_semana = as.Date("2022-01-03")

# sexta-feira
dt_fim_semana = as.Date("2022-01-07")
dt_commoditie_final_semana = "07/01/2022"
...
curva_seg <- read.csv2("curva-pre_2021-12-30.csv")

curva_sex <- read.csv2("curva-pre_2022-01-07.csv")
...
# 
# 
# inflacao_grupo <- inflacao_grupo %>% filter("2021-01-01" <= date & date <= "2021-11-01")
# 
...
#   geom_col() +
#   labs(x="", y="", subtitle = "Variação acumulada em 2021 (%): 9,26\nVariação acumulada em 12 meses (%): 10,74", fill="",
#        caption = "Fonte: Índice de Preços ao Consumidor Amplo (IPCA) - IBGE | Elaboração: BP Investimentos",
...
ibov_graph <- PlotaRetornoSemanal_ibov(Ibov, "Ibovespa", "B3", .05)
ibov_graph
...
sp500_plot <- PlotaRetornoSemanal(SP500, "S&P 500", "FED", .05)
sp500_plot
