...
# segunda-feira
dt_inicio_semana = as.Date("2021-11-08")

# sexta-feira
dt_fim_semana = as.Date("2021-11-12")
dt_commoditie_final_semana = "12/11/2021"
...
# 
# # cdi[2976,1] <- as.Date("2021-11-05")
# # cdi[2976,2] <- as.numeric(7.65)
# 
# ####################################################################
...
curva_seg <- read.csv2("curva-pre_2021-11-05.csv")

curva_sex <- read.csv2("curva-pre_2021-11-12.csv")
