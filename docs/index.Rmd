...
# segunda-feira
dt_inicio_semana = as.Date("2021-11-01")

# sexta-feira
dt_fim_semana = as.Date("2021-11-05")
dt_commoditie_final_semana = "05/11/2021"
...
curva_seg <- read.csv2("curva-pre_2021-10-29.csv")

curva_sex <- read.csv2("curva-pre_2021-11-05.csv")
...
ggplot(acoes_setores_complete_pt1,
  ...
  annotate("text", label = "5 Piores\nPerfomances",
           x = sum(max(acoes_setores_complete_pt1$var_semanal)/2, 0.05),
         #   head(acoes_setores_complete_pt1$var_semanal, n=3)
           y = 3.5,
           size = 2.5,
           fontface = "bold",
           colour = "#c0392b") +
...
ggplot(acoes_setores_complete_pt2,aes(x = var_semanal,  y = reorder(nome_acao_setor, +var_semanal), fill = Color)) + 
  ...
  annotate("text", label = "5 Melhores\nPerfomances",
           ...
           colour = "#0d7539") +
  annotate("text", label = "5 Piores\nPerfomances",
           x = sum(max(acoes_setores_complete_pt2$var_semanal)/2, 0.05),
