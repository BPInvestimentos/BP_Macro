...
# segunda-feira
dt_inicio_semana = as.Date("2021-12-27")

# sexta-feira
dt_fim_semana = as.Date("2021-12-31")
dt_commoditie_final_semana = "31/12/2021"
...
soja_graph <- ggplot(soja_futuro, aes(x = data, y = Close)) +
  geom_line(size = 1.1, colour = "#ffa600") +
  labs(y="Preço do contrato futuro (em Dólar)", x="", fill="",
       title = "Soja NY Futuros - Dez 21 (ZSX1)",
       caption = "Fonte: Investing.com | Elaboração: BP Investimentos",
       colour = "") +
  theme_minimal() +
  theme(legend.position = "bottom",
...
boi_graph <- ggplot(boi_gordo_futuros, aes(x = data, y = Close)) +
  ...
  labs(y="Preço do contrato futuro (em Real)", x="", fill="",
       title = "Boi Gordo Futuros - Dez 21 (BGIc1)",
       caption = "Fonte: Investing.com | Elaboração: BP Investimentos",
       colour = "") +
  theme_minimal() +
  theme(legend.position = "bottom",
...
curva_seg <- read.csv2("curva-pre_2021-12-23.csv")

curva_sex <- read.csv2("curva-pre_2021-12-30.csv")
