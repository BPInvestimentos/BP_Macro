...
# segunda-feira
dt_inicio_semana = as.Date("2022-01-10")

# sexta-feira
dt_fim_semana = as.Date("2022-01-14")
dt_commoditie_final_semana = "14/01/2022"
...
#   # cdi[3015,1] <- as.Date("2021-12-31")
#   # cdi[3015,2] <- as.numeric(9.15)
# 
# ####################################################################
...
curva_seg <- read.csv2("curva-pre_2022-01-07.csv")

curva_sex <- read.csv2("curva-pre_2022-01-14.csv")
