...
# segunda-feira
dt_inicio_semana = as.Date("2021-12-13")

# sexta-feira
dt_fim_semana = as.Date("2021-12-17")
dt_commoditie_final_semana = "17/12/2021"
...
#   cdi[3005,1] <- as.Date("2021-12-17")
#   cdi[3005,2] <- as.numeric(9.15)
# 
# ####################################################################
...
curva_seg <- read.csv2("curva-pre_2021-12-10.csv")

curva_sex <- read.csv2("curva-pre_2021-12-17.csv")
