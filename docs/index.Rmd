...
# segunda-feira
dt_inicio_semana = as.Date("2021-11-29")

# sexta-feira
dt_fim_semana = as.Date("2021-12-03")
dt_commoditie_final_semana = "03/12/2021"
...
#  # cdi[2985,1] <- as.Date("2021-11-19")
#  # cdi[2985,2] <- as.numeric(7.65)
# 
# ####################################################################
...
curva_seg <- read.csv2("curva-pre_2021-11-26.csv")

curva_sex <- read.csv2("curva-pre_2021-12-03.csv")
...
vertical_sep_ipca <- ggplot(contribuicao2, aes(x=variação,y=setor,fill=Color))+
  geom_col() +
  labs(x="", y="", subtitle = "Variação acumulada em 2021 (%): 8,24\nVariação acumulada em 12 meses (%): 10,67", fill="",
       caption = "Fonte: Índice de Preços ao Consumidor Amplo (IPCA) - IBGE | Elaboração: BP Investimentos",
